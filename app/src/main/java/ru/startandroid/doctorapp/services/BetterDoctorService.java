package ru.startandroid.doctorapp.services;
...
public class BetterDoctorService {
    ...
    public static void findDoctorsByLocationAndSpecialty(String specialty, String city, String state, String practice, Callback callback) {
        ...
        urlBuilder.addQueryParameter(Constants.BETTER_DOCTOR_PRACTICE_QUERY_PARAMETER, practice);
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                for (int i = 0; i < resultsJSON.length(); i++) {
                    ...
                    String practice = doctorJSON.getJSONArray("practices").getJSONObject(0).getString("name");
                    ...
                    Doctor doctor = new Doctor(name, specialty, phone, latitude, longitude, street, street2, city, state, practice, zip, bio);
                    doctors.add(doctor);
                }
            }
        } catch (IOException e) {
